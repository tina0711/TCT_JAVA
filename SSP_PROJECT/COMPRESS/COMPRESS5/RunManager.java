...
public class RunManager {
	...
	public static void main(String[] args) {
		...
		if(cmd.contains("#")) {
			...
			runManager.key = tmp[1];
			file = tmp[0];
		}else {
			file = cmd;
		}
		
		runManager.subDirList("./BIGFILE", file);
	...
	public String encrpytString(String line) {
		String encrypt = "";
	...
	public void encryptTable(String line) {
		String encrypt = "";
	...
	public void compressLine(String fileName) {
		...
		while(true) {
			...
			encryptStr = encrpytString(line);
			changeStr = changeChar(line);
			compressCh = compressChar(encryptStr);
